...
<html>
    <head>
        ...
        <title>EasyRTC Data Channel File-sharing</title>
        ...
        <script type="text/javascript" src="js/data_channel_filesharing.js"></script>
    ...
    <body onload="connect()">
        <div id="container">
            ...
            <div id="main">
                <h1>EasyRTC Data Channel File-sharing</h1>
